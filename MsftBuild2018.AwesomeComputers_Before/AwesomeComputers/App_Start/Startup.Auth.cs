    ...
    public partial class Startup
    {
        ...
        */
        ...
        private async Task OnAuthorizationCodeReceived(AuthorizationCodeReceivedNotification notification)
        {
            ...
            try
            {
                AuthenticationResult result = await cca.AcquireTokenByAuthorizationCodeAsync(code, new [] { string.Empty });
				Trace.WriteLine($"Code: '{code}', Token: '{result.AccessToken}'");
            }
            catch (Exception ex)
            {
                //TODO: Handle
